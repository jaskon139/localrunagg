...
rem aggtunnel
start /MIN /B c:\opensource\aggligator-util-v0.11.0\target\debug\agg-tunnel.exe client -g --port 22:4301 --port 1194:4194 --tcp 192.168.43.1:7002 --tcp 192.168.44.1:7003 --tcp 192.168.45.1:15959 --tcp 172.24.48.1:7001 -n
